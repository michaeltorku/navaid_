...
class StereoBM(BlockMatcher):
    ...
    def _replace_bm(self):
        ...
        self._block_matcher = cv2.StereoBM.create()
        self._block_matcher.setMinDisparity(4)
        self._block_matcher.setNumDisparities(128)
        self._block_matcher.setBlockSize(21)
        self._block_matcher.setSpeckleRange(16)
        self._block_matcher.setSpeckleWindowSize(45)
...
class StereoSGBM(BlockMatcher):
    ...
    def _replace_bm(self):
        ...
        self._block_matcher = cv2.StereoSGBM.create()
        self._block_matcher.setMinDisparity(4)
        self._block_matcher.setNumDisparities(128)
        self._block_matcher.setBlockSize(21)
        self._block_matcher.setSpeckleRange(16)
